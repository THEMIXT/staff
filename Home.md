...
|`/freeze`|Freezes/unfreezes a player. Either you specify enabled/disabled or you just freeze and freezemode will be toggled|`-T`|`/freeze player1` `/freeze enabled player1` `/freeze player1 -Tspawn -S`|
...
|`/revive`|Revive let's you restore a player's inventory after a players has died.|`-T`|`/revive player1`|
